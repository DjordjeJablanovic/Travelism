...
const Activities = () => {
  return (
    <section className='w-full max-w-[1920px] mx-auto lg:py-16 bg-active lg:px-10 xl:px-28 md:py-10 px-5 py-10'>
       <div className='w-full text-white font-secondary flex justify-between items-center '>
