...
const Explore = () => {
  return (
    <section className='w-full max-w-[1920px] mx-auto lg:py-5 '>
        <div className='flex flex-col lg:flex-row items-center justify-center'>
            {/* left side */}
            <div className=' flex flex-col items-center lg:items-start justify-center px-1 md:px-10'>
                <h2 className='text-[50px] text-center lg:pt-5 md:text-[74px] font-bold mb-2 font-primary'>Just Explore About Us</h2>
                <p className='py-2 text-[16px] md:text-[18px]  px-3 lg:w-[800px] leading-[30px] md:leading-[36px] text-gray-700'>Metus odio sed purus justo. Eget egestas non ornare tincidunt ut. Id eget erat libero dui tellus viverra. Massa risus et at turpis adipiscing faucibus. At faucibus lorem sodales blandit nunc, faucibus consectetur tempor diam dui. Nam neque, non leo mauris pellentesque odio. </p>
                <p className='py-2 text-[16px] md:text-[18px]  px-3 lg:w-[800px] leading-[30px] md:leading-[36px] text-gray-700'>Auctor fermentum, sit iaculis aliquam commodo non. Metus imperdiet tristique ultrices ut viverra ipsum id erat libero dui tellus vive  blandit nunc, faucibus consecte malesuada.</p>
